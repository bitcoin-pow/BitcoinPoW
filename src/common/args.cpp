...
const char * const BITCOIN_CONF_FILENAME = "bitcoin-pow.conf";
...
{
    // Windows: C:\Users\Username\AppData\Roaming\Bitcoin-PoW
    // macOS: ~/Library/Application Support/Bitcoin-PoW
    // Unix-like: ~/.bitcoin-pow
#ifdef WIN32
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bitcoin-PoW";
#else
    fs::path pathRet;
...
#ifdef __APPLE__
    return pathRet / "Library/Application Support/Bitcoin-PoW";
#else
    return pathRet / ".bitcoin-pow";
#endif
#endif
}
