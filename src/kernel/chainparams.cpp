...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000255dedbab9b892fd5a4c");
        ...
        // Mandatory anchor: history is downloaded and replayed from genesis.
        consensus.historical_checkpoint = Consensus::HistoricalCheckpoint{
            141410, uint256S("05d553c0600bdeff22592f1331c8bc9fd534c35cd75a892c32055dea914cd00e")};
        checkpointData = {{
